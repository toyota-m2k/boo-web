...
import {MediaFile, mediaList as observableMediaList, retrieveMediaList} from "./store/BooClient";
...
export function PersistentDrawerLeft() {
  ...
  const handleMediaSelection = (v:MediaFile|null) => {
    playingItemInfo.reset()
    setCurrentMedia(v)
  }
  ...
  return (
      <Box sx={{ display: 'flex' }}>
        ...
        >
          ...
          <Divider />
          <MediaListView onSelected={handleMediaSelection} currentMedia={currentMedia} mediaList={mediaList}/>
        </Drawer>
        <Main open={open}>
          <DrawerHeader />
